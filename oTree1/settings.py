...
#from otree.db.models import ForeignKey #for slider
#from slider_task.models import BaseSlider, SliderPlayer #for slider
...
SESSION_CONFIGS = [
    ...
    {
    	'name': 'TeresaDuarte',
        'display_name': "Teresa & Duarte's Project",
        'num_demo_participants': 1,
        'app_sequence': ['TeresaDuarte'],
...
SECRET_KEY = '5o4*j#n155o=rwt)3(j1lhbt6hcu#wj3))d_svb2s5qi&2zm#!'

# if an app is included in SESSION_CONFIGS, you don't need to list it here
INSTALLED_APPS = ['otree']#,'slider_task'] #slider_task installed
